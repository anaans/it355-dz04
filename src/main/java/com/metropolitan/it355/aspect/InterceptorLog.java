...
public void before(Method arg0, Object[] arg1, Object arg2) throws Throwable {
    ...
    System.out.println("******"); }
@After("execution(* com.it355.dao.impl.KnjigaDaoImpl.addKnjiga(..))") 
...
@AfterThrowing(
        pointcut = "execution(*"
                + " com.it355.dao.impl.KnjigaDaoImpl.addKnjigaThrowException())",
        throwing= "error") 
...
@AfterReturning(pointcut = "execution(* com.metropolitan.it355.aop.KnjigaDaoImpl.addKnjigaRet())", returning = "returnValue")
...
@Around("execution(* execution(* "
        + "com.it355.dao.impl.KnjigaDaoImpladdKnjigaAround(..))") 
